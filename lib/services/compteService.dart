...
import 'package:goukodi_transfert_flutter/models/compte.dart';
...
class CompteService {
  ...
  getCompte() async{
    ...
    for(var u in user){
      Compte mesuser=new Compte(id:u["id"],solde:u["solde"],numero:u["numero"],partenaire:u["partner"],depot:u["depot"],iri: u['@id']);
      users.add(mesuser);
    }
    return users;
